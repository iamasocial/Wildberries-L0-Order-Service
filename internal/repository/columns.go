...
const (
	orderColumns                = "order_uid, track_number, entry, locale, internal_signature, customer_id, delivery_service, shardkey, sm_id, date_created, oof_shard"
	deliveryColumns             = "name, phone, zip, city, address, region, email"
	deliveryColumnsWithOrderUID = "order_uid, name, phone, zip, city, address, region, email"
	paymentColumns              = "transaction, request_id, currency, provider, amount, payment_dt, bank, delivery_cost, goods_total, custom_fee"
	paymentColumnsWithOrderUID  = "order_uid, transaction, request_id, currency, provider, amount, payment_dt, bank, delivery_cost, goods_total, custom_fee"
	itemColumns                 = "chrt_id, track_number, price, rid, name, sale, size, total_price, nm_id, brand, status"
	itemColumnsWithOrderUID     = "order_uid, chrt_id, track_number, price, rid, name, sale, size, total_price, nm_id, brand, status"
)
